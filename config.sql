...
CREATE USER QUANG2 IDENTIFIED BY "123";
...
GRANT CREATE SESSION TO QUANG2;
...
CREATE PROFILE "LOGIN" LIMIT FAILED_LOGIN_ATTEMPTS 3 PASSWORD_LOCK_TIME 5;
drop profile "LOGIN"

select * from dba_tablespaces
SELECT USERNAME, default_tablespace  FROM DBA_USERS where username='CUONG'
ALTER USER ADMIN
DEFAULT TABLESPACE SYSTEM

select * from CHNONGSAN.HANGHOA